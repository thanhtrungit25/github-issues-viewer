...
let issues = [
  {
    ...
    labels_url:
      "https://api.github.com/repos/rails/rails/issues/27599/labels{/name}",
    comments_url:
      "https://api.github.com/repos/rails/rails/issues/27599/comments",
    ...
    user: {
      ...
      following_url:
        "https://api.github.com/users/NickLaMuro/following{/other_user}",
      gists_url: "https://api.github.com/users/NickLaMuro/gists{/gist_id}",
      starred_url:
        "https://api.github.com/users/NickLaMuro/starred{/owner}{/repo}",
      subscriptions_url:
        "https://api.github.com/users/NickLaMuro/subscriptions",
    ...
    assignee: {
      ...
      following_url:
        "https://api.github.com/users/sgrif/following{/other_user}",
    ...
    assignees: [
      {
        ...
        gists_url: "https://api.github.com/users/sgrif/gists{/gist_id}",
        starred_url:
          "https://api.github.com/users/sgrif/starred{/owner}{/repo}",
        subscriptions_url: "https://api.github.com/users/sgrif/subscriptions",
        organizations_url: "https://api.github.com/users/sgrif/orgs",
        repos_url: "https://api.github.com/users/sgrif/repos",
        events_url: "https://api.github.com/users/sgrif/events{/privacy}",
        received_events_url:
          "https://api.github.com/users/sgrif/received_events",
        type: "User",
        site_admin: false
      }
    ],
  ...
  },
  {
    ...
    repository_url: "https://api.github.com/repos/rails/rails",
    labels_url:
      "https://api.github.com/repos/rails/rails/issues/27598/labels{/name}",
    comments_url:
      "https://api.github.com/repos/rails/rails/issues/27598/comments",
  ...
  },
  {
    ...
    repository_url: "https://api.github.com/repos/rails/rails",
    labels_url:
      "https://api.github.com/repos/rails/rails/issues/27597/labels{/name}",
    comments_url:
      "https://api.github.com/repos/rails/rails/issues/27597/comments",
    ...
    user: {
      ...
      following_url:
        "https://api.github.com/users/brchristian/following{/other_user}",
      gists_url: "https://api.github.com/users/brchristian/gists{/gist_id}",
      starred_url:
        "https://api.github.com/users/brchristian/starred{/owner}{/repo}",
      subscriptions_url:
        "https://api.github.com/users/brchristian/subscriptions",
      ...
      received_events_url:
        "https://api.github.com/users/brchristian/received_events",
      type: "User",
      site_admin: false
    },
    labels: [
    ...
    assignee: {
      ...
      following_url:
        "https://api.github.com/users/pixeltrix/following{/other_user}",
      gists_url: "https://api.github.com/users/pixeltrix/gists{/gist_id}",
      starred_url:
        "https://api.github.com/users/pixeltrix/starred{/owner}{/repo}",
      ...
      received_events_url:
        "https://api.github.com/users/pixeltrix/received_events",
      type: "User",
      site_admin: false
    },
    assignees: [
      {
        ...
        starred_url:
          "https://api.github.com/users/pixeltrix/starred{/owner}{/repo}",
        subscriptions_url:
          "https://api.github.com/users/pixeltrix/subscriptions",
        organizations_url: "https://api.github.com/users/pixeltrix/orgs",
        repos_url: "https://api.github.com/users/pixeltrix/repos",
        events_url: "https://api.github.com/users/pixeltrix/events{/privacy}",
        received_events_url:
